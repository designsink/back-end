...
public class ProductController {
	...
	@PatchMapping()
	public ResponseEntity<String> updateProductSequences(
		@RequestParam("category") ProductType productType,
		@RequestBody List<ProductModifyRequestDto> requestDtos) {
		productService.modifySequences(productType, requestDtos);
